...
namespace acut
{
    ...
    {
        return libdaemon::Utils::UTF8ToWstring( ptr );
    }

    template <>
    inline std::basic_string<char> ensure_tchar(const wchar_t* ptr)
    {
        return libdaemon::Utils::WstringToUTF8( ptr );
    }
    ...
    {
        return libdaemon::Utils::UTF8ToWstring(std::string(1, ch)).front();
    }

    template <>
    inline char ensure_tchar(wchar_t ch)
    {
        return libdaemon::Utils::WstringToUTF8( std::wstring( 1, ch ) ).front( );
    }
